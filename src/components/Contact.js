       ...
       <div className=" pb-40">
        ...
        <div className=" mx-auto max-w-lg shadow-lg rounded-xl px-10 overflow-hidden bg-gray-100 ">
            ...
            <form action="#" className="space-y-8">
                ...
                <button type="submit" className="py-2 px-2 text-sm font-medium text-center  hover:text-sky-400 rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
            </form>
        </div>
      </section>
      </div>
